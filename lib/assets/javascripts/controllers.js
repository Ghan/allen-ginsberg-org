...
angular.module('gApp.controllers', []).
  ...
  .controller('blogCtrl', ['$scope', 'Blog', '$routeParams', 'blogService', 'Analytics', '$window',
    function($scope, Blog, $routeParams, blogService, Analytics, $window) {
    ...
    $scope.visitBlogPage = function (url) {
      Analytics.trackEvent('visitBlog', url);
  ...
  .controller('biographyCtrl', ['$scope', 'Timeline', 'bioMichaelService', 'timelineService', 'timelinePhotoService', 'Analytics', function($scope, Timeline, bioMichaelService, timelineService, timelinePhotoService, Analytics) { 
    ...
    $scope.currentItem = { 'title': "Click a decade and title to browse life events."};
    $scope.selected;
  ...
  .controller('worksDetailCtrl', ['$scope', 'Works', '$routeParams', 'worksDetailService', 'similarWorksService', 'itemsInArchiveService', 'Analytics', '$window',
    function($scope, Works, $routeParams, worksDetailService, similarWorksService, itemsInArchiveService, Analytics, $window) {
    ...
    $scope.work = Works;
    $scope.clickPurchase = function (item) {
      Analytics.trackEvent('purchase', item.name);
      $window.location.href = item.amazon_slash_itunes_url;
    };
  ...
  .controller('adminCtrl', ['$scope', 'resetCacheService', function($scope, resetCacheService) {
    ...
    $scope.getEditPage = function(editpage){
      ...
      $scope.targetURL = "http://allenginsberg.org/locomotive/content_types/"+contentType+"/entries/"+id+"/edit";
