      ...
      similarWorksService.getData(api_token, $scope.geo, $scope.notable, $scope.date, function(data){
        for (var i = data.length - 1; i >= 0; i--) {
          ...
          if(data[i].imageThumb.indexOf("blank.png") != -1){
            ...
            imageURL = "https://images1-focus-opensocial.googleusercontent.com/gadgets/proxy?url=https://allenginsberg.s3.amazonaws.com"+data[i].imageThumb+"&container=focus&resize_w=100&refresh=2592000";
          }
