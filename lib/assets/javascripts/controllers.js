...
angular.module('gApp.controllers', []).
  ...
  .controller('worksDetailCtrl', ['$scope', 'Works', '$routeParams', 'worksDetailService', 'similarWorksService', 'itemsInArchiveService', 'Analytics',
    function($scope, Works, $routeParams, worksDetailService, similarWorksService, itemsInArchiveService, Analytics) {
