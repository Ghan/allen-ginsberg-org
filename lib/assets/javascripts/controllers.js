...
angular.module('gApp.controllers', []).
  ...
  .controller('archiveDetailCtrl', ['$scope', 'Archive', '$routeParams', 'archiveDetailService', 'similarArchiveItemsService', 'publishedInService', 'atThisTimeService', function($scope, Archive, $routeParams, archiveDetailService, similarArchiveItemsService, publishedInService, atThisTimeService) {
    archiveDetailService.getData(api_token, $routeParams.slug, function(data){
      ...
      similarArchiveItemsService.getData(api_token, $scope.item.geo, $scope.item.notable, $scope.item.misc, $scope.item.date, function(archiveData){
